		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
										...
										<!-- Apellidos -->  
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_reg_telefono" name="telefono" placeholder="Ingrese Teléfono" type="tel" maxlength="9"/>
		                                        </div>
		                                    </div>
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
										...
										<!-- Apellidos -->  
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_act_telefono" name="telefono" placeholder="Ingrese  Teléfono" type="tel" maxlength="9"/>
		                                        </div>
		                                    </div>
