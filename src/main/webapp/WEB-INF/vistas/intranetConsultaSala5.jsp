...
<div class="container" style="margin-top: 6%;font-family: 'Albert Sans', sans-serif;" align="center"><h4>Consultas
    Sala</h4></div>
...
<div class="container mt-5" style="margin-top: 1% ;margin-bottom: 3% ;font-family: 'Albert Sans', sans-serif;">
    ...
    <div class="row" style="margin-top: 6%;">
        <div class="col-md-3"
            ...
            <form class="form-inline" id="id_form_filtrar" role="form">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
							...
							<span class="input-group-text"><i
                                ...
                                <select class="form-select" name="idTipoSala" id="id_filtro_tiposala">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" name="idSede" id="id_filtro_sede">
                                    <option value="">Seleccionar</option>
                                </select>
                            </div>
                        </div>
                ...
                <div align="center" class="row mb-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <button type="button" id="id_btn_filtrar" class="button-82-pushable" role="button">
                                <span class="button-82-shadow"></span>
                                <span class="button-82-edge"></span>
                                <span class="button-82-front text">
                                     <span class="input-group-addon"><i class="bi bi-funnel"></i></span>
                                  Filtrar
                        </span>
                            </button>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <button  type="button" id="id_btn_pdf" class="button-pdf-pushable" role="button">
                                <span class="button-pdf-shadow"></span>
                                <span class="button-pdf-edge"></span>
                                <span class="button-pdf-front text">
                                     <span class="input-group-addon"><i class="bi bi-filetype-pdf"></i></span>
                                  PDF
                        </span>
                            </button>
                        </div>
        ...
        <div class="col-md-9"
             style="box-shadow: blue 0px 0px 0px 2px inset, rgb(255, 255, 255) 10px -10px 0px -3px, rgb(31, 193, 27) 10px -10px, rgb(255, 255, 255) 20px -20px 0px -3px, rgb(255, 217, 19) 20px -20px, rgb(255, 255, 255) 30px -30px 0px -3px, rgb(255, 156, 85) 30px -30px, rgb(255, 255, 255) 40px -40px 0px -3px, rgb(255, 85, 85) 40px -40px;padding:30px;">
